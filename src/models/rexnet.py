...
default_cfgs = dict(
    rexnet_100=_cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rexnet/rexnetv1_100-1b4dddf4.pth'
    ),
    rexnet_130=_cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rexnet/rexnetv1_130-590d768e.pth'
    ),
    rexnet_150=_cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rexnet/rexnetv1_150-bd1a6aa8.pth'
    ),
    rexnet_200=_cfg(
        url=
        'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rexnet/rexnetv1_200-8c0b7f2d.pth'
    ),
    rexnetr_100=_cfg(url=''),
    rexnetr_130=_cfg(url=''),
    rexnetr_150=_cfg(url=''),
    rexnetr_200=_cfg(url=''),
)
...
def _block_cfg(width_mult=1.0,
    ...
    for i in range(depth // 3):
        out_chs_list.append(
            make_divisible(round(base_chs * width_mult), divisor=ch_div))
...
def _create_rexnet(variant, pretrained, **kwargs):
    ...
    return build_model_with_cfg(ReXNetV1,
                                variant,
                                pretrained,
...
def rexnetr_130(pretrained=False, **kwargs):
    ...
    return _create_rexnet('rexnetr_130',
                          pretrained,
                          width_mult=1.3,
                          ch_div=8,
                          **kwargs)
...
def rexnetr_150(pretrained=False, **kwargs):
    ...
    return _create_rexnet('rexnetr_150',
                          pretrained,
                          width_mult=1.5,
                          ch_div=8,
                          **kwargs)
...
def rexnetr_200(pretrained=False, **kwargs):
    ...
    return _create_rexnet('rexnetr_200',
                          pretrained,
                          width_mult=2.0,
                          ch_div=8,
                          **kwargs)
